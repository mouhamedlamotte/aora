...
const {setUser, setIsLogged} = useGlobalContext()
  ...
  const submit =  async () => {
    ...
    try {
      await singIn(from.email, from.password);
      ...
      <ScrollView>
        <View className="w-full justify-center px-4 h-full min-h-screen">
            ...
            <View className="justify-center pt-4 flex-row gap-2">
                <Text className="text-lg text-gray-100 font-pregular mt-7">Don't have an account? <Link href="/sign-up" className="text-lg text-secondary font-psemibold">Sign Up</Link></Text>
            </View>
        </View>
      </ScrollView>
    </SafeAreaView>
